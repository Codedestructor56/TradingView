...
def curr_stats_print():
    current_state=get_curr_info(info_src)
    ...
    print("Current Account status: "+current_state[3][:4]+"\n")
    print("Current Account Balance: "+current_state[3][11:]+"\n")
...
if __name__ == "__main__":
    ...
    change_exp_time(int(input("Enter the number of ticks, enter 0 if you don't want to change the time: ")))
